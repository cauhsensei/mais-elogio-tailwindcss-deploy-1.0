...
const features = [
  {
    name: 'Amplie sua marca',
    description:
      'Divulgue a opinião dos seus clientes e atraia novos consumidores a se relacionarem com a sua marca.',
    icon: DeviceUserIcon,
    screen: InviteScreen,
  },
  {
    name: 'Credibilidade',
    description:
      'Influencie positivamente os usuários em busca de informações sobre sua empresa.',
  ...
  },
  {
    name: 'Confiança',
    description:
      'Colete e exibe avaliações autênticas de clientes',
    ...
    >
      <Container>
        <div className="mx-auto max-w-2xl lg:mx-0 lg:max-w-3xl">
          ...
          Recursos para ampliar a visibilidade da sua marca. Experimente você mesmo.
          </h2>
          <p className="mt-2 text-lg text-gray-400">
          Influencie positivamente os usuários em busca de informações sobre sua empresa. Evite dúvidas e desconfianças durante o processo de compra com o MaisElogio, referência em avaliações autênticas.
          </p>
        </div>
      </Container>
