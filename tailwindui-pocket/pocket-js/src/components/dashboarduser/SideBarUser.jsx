...
const navigation = [
    { name: 'Área do consumidor', href: '/user/dashboard', icon: HomeIcon, current: false },
    { name: 'Meus comentários', href: '/user/dashboard/meuscomentarios', icon: StarIcon, current: false },
    { name: 'Meus dados', href: '/user/dashboard/meusdados', icon: UserIcon, current: false },
    //   { name: 'Projects', href: '#', icon: FolderIcon, current: false },
    //   { name: 'Calendar', href: '#', icon: CalendarIcon, current: false },
    //   { name: 'Reports', href: '#', icon: ChartPieIcon, current: false },
]
const teams = [
    { name: 'Configurações', href: '/user/dashboard/configuracoes', icon: Cog6ToothIcon, current: false },
    ...
    return (
        ...
        <Header />
            <div>
                            ...
                            <ul role="list" className="flex flex-1 flex-col gap-y-7">
                                ...
                                <li className="-mx-6 mt-auto">
                                    ...
                                    >
                                        ...
                                        <span aria-hidden="true">{userData.first_name || 'User'}</span>
                                    </a>
                                </li>
                            </ul>
                        </nav>
                ...
                <div className="sticky top-0 z-10 flex items-center gap-x-6 bg-indigo-600 px-4 py-4 shadow-sm sm:px-6 lg:hidden">
                <button type="button" className="-m-2.5 p-2.5 text-indigo-200 lg:hidden" onClick={() => setSidebarOpen(true)}>
                    <span className="sr-only">Open sidebar</span>
                    <Bars3Icon className="h-6 w-6" aria-hidden="true" />
                </button>
                <div className="flex-1 text-sm font-semibold leading-6 text-white">Área do consumidor</div>
                <a href="#">
                    <span className="sr-only">Your profile</span>
                    {userData.photoURL ? (
                        <Image
